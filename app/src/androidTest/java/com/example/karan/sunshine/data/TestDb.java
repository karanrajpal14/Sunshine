...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Failure to insert values into Weather table", weatherRowID != -1);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Validation of weather values failed", weatherCursor, weatherValues);
    ...
    public long insertLocation() {
        ...
        assertTrue("Failure to insert values into Location table", locationRowID != -1);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Invalid location data", locationCursor, locationValues);
        assertFalse("Error: More than one record returned from location query", locationCursor.moveToNext());
