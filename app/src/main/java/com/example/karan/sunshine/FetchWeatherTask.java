...
class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.pref_units_metric_key),
                mContext.getString(R.string.pref_units_metric_key));

        if (unitType.equals(mContext.getString(R.string.pref_units_imperial_key))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_units_metric_key))) {
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            forecastArr = getWeatherDataFromJson(forecastJSON, locationQuery);
    ...
    protected void onPostExecute(String[] strings) {
        if (strings != null && MainActivityFragment.forecastAdapter != null) {
            MainActivityFragment.forecastAdapter.clear();
            for (String dayForecastStr : strings) {
                MainActivityFragment.forecastAdapter.add(dayForecastStr);
            }
